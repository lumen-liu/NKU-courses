...
int main()
{
	...
	cout << endl << "请输入第一个矩阵：" << endl;
	cin >> x1;
	cout << endl << "请输入第二个矩阵：" << endl;
	cin >> x2;
	x3 = x1 + x2;
	cout << endl << "两个矩阵相加的结果为：" << endl << x3 << endl;
	x4 = x1 - x2;
	cout << "两个矩阵相减的结果为：" << endl << x4 << endl;
	x5 = x1 * x2;
	cout << "两个矩阵相乘的结果为：" << endl << x5 << endl;
	return 0;
}